DROP PACKAGE BODY SBLPROD_AME_AUG.PKG_GAIN_GL_TRF;

CREATE OR REPLACE PACKAGE BODY SBLPROD_AME_AUG.PKG_GAIN_GL_TRF
...
IS
   ...
   PROCEDURE SP_REVARSE_GL (P_ENTITY_CODE   IN NUMBER,
   ...
   BEGIN
      ...
      LOOP
         ...
         THEN
            ...
            MOVE_TO_TRANREC_GL (
               ...
               || V_TTY_TRANREC (IDX).V_CURR_CODE,
               'Transaction rate 1');
            V_CONS_AC_AMT := V_CONS_AC_AMT + V_TTY_TRANREC (IDX).V_AC_AMOUNT;
            V_CONS_BC_AMT := V_CONS_BC_AMT + V_TTY_TRANREC (IDX).V_BC_AMOUNT;
      ...
      THEN
         ...
         MOVE_TO_TRANREC_GL (
            ...
            V_CURR_CODE,
            'Gain loss GL adjustment',
            'For GL ' || P_EXCHANGE_GL || ' Currency ' || V_CURR_CODE,
            'Transaction rate');
      ELSIF V_CONS_AC_AMT > 0 THEN
         V_NUMBER_OF_TRAN := V_NUMBER_OF_TRAN + 1;
         MOVE_TO_TRANREC_GL (
            P_BRN_CODE,
            'C',
