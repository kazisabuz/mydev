DROP PACKAGE SBLPROD.PKG_LN_RECLASSIFY;

CREATE OR REPLACE PACKAGE SBLPROD.PKG_LN_RECLASSIFY IS
...
/
DROP PACKAGE BODY SBLPROD.PKG_LN_RECLASSIFY;

CREATE OR REPLACE PACKAGE BODY SBLPROD.PKG_LN_RECLASSIFY
IS
   W_CBD                         DATE;
   W_ASON_DATE                   DATE;
   ...
   */
   ...
   BEGIN
     ...
     W_SQL :=
       ...
       AND PRODUCT_CODE NOT IN (2042,2201,2205,2301,2311,2315,2319,2323,2324,2325,2401,2502,2508,2514,2546,2547,2063) 
      ...
      LOOP
         ...
         THEN
            ...
            THEN
               ...
               THEN
                  W_OVERDUE_PRD :=
                     (FLOOR (MONTHS_BETWEEN (W_ASON_DATE, W_LIMIT_EXP_DATE)));
