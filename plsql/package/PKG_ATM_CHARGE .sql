DROP PACKAGE SBLPROD.PKG_ATM_CHARGE;

CREATE OR REPLACE PACKAGE SBLPROD.PKG_ATM_CHARGE IS

  -- AUTHOR  : Mohammad Ali
  -- CREATED : 04-DEC-2016
  -- PURPOSE : ATM Charge Deduct from accounts.
...
END PKG_ATM_CHARGE;
/
DROP PACKAGE BODY SBLPROD.PKG_ATM_CHARGE;

CREATE OR REPLACE PACKAGE BODY SBLPROD.PKG_ATM_CHARGE IS
