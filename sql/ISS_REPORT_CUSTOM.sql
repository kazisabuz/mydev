/* Formatted on 01/27/2019 5:01:14 PM (QP5 v5.227.12220.39754) */
SELECT :P_BRANCH_CODE COL1,
       (select mbrn_name from mbrn where mbrn_code=:P_BRANCH_CODE) COL2,
       0 "COL3",
       0 COL4,
       0 COL5,
       0 COL6,
       ...
       - NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                  :P_ASON_DATE,
                                  'A0501',
                                  'F12'),
              0)
       ...
       - NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
              ...
              0)
       + CASE
            WHEN (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                             :P_ASON_DATE,
                                             'A0501',
                                             'F12'),
                         0)
       ...
       (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
        ...
        + NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   ...
                                   'F12'),
               0))
               + CASE  WHEN ( (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                     :P_ASON_DATE,
                                     'A0905',
                                     'F12'),
                 0)
       ...
       - (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
          ...
          + NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                     ...
                                     'L2605',
                                     'F12'),
                 0))) >0 THEN ( (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                     :P_ASON_DATE,
                                     'A0905',
                                     'F12'),
                 0)
...
'L2114'))
       ...
       (SELECT NVL (SUM (FN_GET_ASON_ACBAL (1,
        ...
        0   COL28,
      (SELECT sum(COL29)
from (SELECT  ACNTS_CLIENT_NUM, NVL (SUM (FN_GET_ASON_ACBAL (ACNTS_ENTITY_NUM,
                                            ACNTS_INTERNAL_ACNUM,
                                            ACNTS_CURR_CODE,
                                            :P_ASON_DATE,
                                            :P_ASON_DATE)),
 ...
 WHERE     ACNTS_ENTITY_NUM = 1
       ...
       having SUM (FN_GET_ASON_ACBAL (ACNTS_ENTITY_NUM,
                                            ACNTS_INTERNAL_ACNUM,
                                            ACNTS_CURR_CODE,
                                            :P_ASON_DATE,
                                            :P_ASON_DATE))>10000000)) COL29,
...
(  (NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   ...
                                   'A0501',
                                   'F12'),
               0) +NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   :P_ASON_DATE,
                                   'A0506',
                                   'F12'),
               0))
        - NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   ...
                                   'L2304',
                                   'F12'),
               0))<0 THEN ABS((  (NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   :P_ASON_DATE,
                                   'A0501',
                                   'F12'),
               0) +NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
       ...
       (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
        ...
        + NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                   ...
                                   'L2613',
                                   'F12'),
               0)) + CASE WHEN  (  NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                                     :P_ASON_DATE,
                                     'L2608',
                                     'F12'),
                 0)
...
+
   ...
   NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
       ...
       + NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                               ...
                               'F42B'),
              0)
       + abs(NVL (FN_ISS_HEAD_BAL (:P_BRANCH_CODE,
                               :P_ASON_DATE,
                               'I0112',
                               'F42B'),
              0))
